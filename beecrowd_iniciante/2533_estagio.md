...
![](https://resources.beecrowd.com/gallery/images/novos/estagio_fig.png)


, onde **N_1**, **N_2**, ..., **N_M** são suas notas em cada disciplina, e **C_1**, **C_2**, ..., **C_M** são as cargas horárias das discplinas respectivas.
