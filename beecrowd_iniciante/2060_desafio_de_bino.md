...
**Categoria:** Iniciante
**Assunto:** Estrutura de repetição
**Nivel:** 1
**Autor:** Por Thalyson Nepomuceno, UECE  Brasil
**Timelimit: 1**
...
A segunda linha contém **N** inteiros **L_i** (1 ≤ **L_i** ≤ 100), representando os números da lista de Bino.
