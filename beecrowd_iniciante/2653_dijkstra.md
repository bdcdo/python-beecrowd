...
**Assunto:** Sets
**Nivel:** 2
**Autor:** Por Abner Samuel P. Palmeira, IFSULDEMINAS  Brazil
**Timelimit: 1**
...
A entrada consiste de várias linhas e cada uma contém uma string que descreve uma das jóias de Dijkstra. Essa string é composta apenas dos caracteres '(' e ')', a soma do tamanho de todas as string não excede 10^6.
