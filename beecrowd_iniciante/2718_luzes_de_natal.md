...
A primeira linha da entrada contém um número inteiro **N** (1 ≤ **N** ≤ 10^3) representando a quantidade de grupos que Giovanna anotou. As próximas **N** linhas contém um inteiro **X** cada uma representando o equivalente decimal do número que representa o grupo.
