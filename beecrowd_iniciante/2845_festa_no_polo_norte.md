...
**Nivel:** 3
**Autor:** Por Francisco Elio Parente Arcos Filho, UEA  Brazil
**Timelimit: 1**
...
A primeira linha da entrada contém um inteiro **N** (1 ≤ **N** ≤ 10^4) o qual representa a quantidade de números escritos na carta de Giovana. A segunda linha da entrada possui **N** números inteiros **A_i** (1 ≤ **A_i** ≤ 10^5) representando os identificadores dos duendes escritos na carta.
