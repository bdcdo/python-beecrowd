...
**Nivel:** 3
**Autor:** Por Maratona de Programação 2019, SBC  Brazil
**Timelimit: 1**
...
A primeira linha da entrada contém um inteiro **N**, satisfazendo 2 ≤ **N** ≤ 10^4 . As **N** linhas seguintes conterão **N** inteiros positivos **v _1** , . . . , **v_N** , um em cada linha, correspondentes ao número de votos recebido por cada um dos candidatos, em ordem de inscrição. Como a população do Reino dos Emparelhamentos é de 100.000 pessoas, o número total de votos não será superior a este valor, ou \(\sum_{k=1}^{N} v_i \le 100.000\).
