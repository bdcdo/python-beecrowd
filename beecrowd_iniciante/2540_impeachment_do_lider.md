...
A entrada contém vários casos de teste. A primeira linha de cada caso contém o inteiro **N** (1 ≤ **N** ≤ 10^5), o número de jogadores em seu time. A próxima linha contém **N** inteiros **v_1**, ..., **v_N** (**v_i** = 0 ou 1), indicando os votos dos jogadores. O valor 1 indica um voto favorável ao *impeachment*, enquanto o valor 0 indica um voto contrário ao mesmo.
