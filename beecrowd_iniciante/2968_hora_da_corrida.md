...
**Nivel:** 5
**Autor:** Por Maratona SBC de Programação  Brazil
**Timelimit: 1**
...
A entrada consiste de uma única linha que contém dois inteiros, **V** e **N** (1 ≤ **V**;**N** ≤ 10^4), onde **V** é o número pretendido de voltas e **N** é o número de placas na pista.
