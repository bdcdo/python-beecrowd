...
**Assunto:** -
**Nivel:** 1
**Autor:** Por Cláudio L. Lucchesi, Fábio D. Moreira  Brazil
**Timelimit: 1**
...
A entrada consiste de uma linha com quatro números inteiros **T1**, **T2**, **T3**, **T4**, indicando o número de tomadas de cada uma das quatro réguas (2 ≤ **T_i** ≤ 6).
