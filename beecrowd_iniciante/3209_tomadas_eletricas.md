...
**Assunto:** Fórmula
**Nivel:** 1
**Autor:** Por Mats Petter Pettersson  Iceland
**Timelimit: 1**
...
A entrada vai começar com um único inteiro 1 ≤ **N** ≤ 20, indicando o número de casos de teste a seguir. Em seguida, seguem **N** linhas, cada uma descrevendo um caso de teste. Cada caso de teste começa com um inteiro 1 ≤ **K** ≤ 10, indicando o número de filtros de linha no caso de teste. Em seguida, seguem, na mesma linha, **K** inteiros separados por espaços simples, **O_1** **O _ 2** ... **O_K**, onde 2 ≤ **O_i** ≤ 10, indicando o número de tomadas em cada filtro de linha.
