...
**Nivel:** 1
**Autor:** Por Maratona de Programação da SBC 2018  Brazil
**Timelimit: 1**
...
A primeira linha da entrada contém um inteiro **N** (1 ≤ **N** ≤ 10^4 ), indicando o número de jogos na simulação. Cada uma das **N** linhas seguintes contém um inteiro: 1, 2 ou 3; representando o número da porta que contém o carro naquele jogo.
