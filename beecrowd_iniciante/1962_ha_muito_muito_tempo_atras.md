...
A entrada tem várias linhas. A primeira tem um inteiro positivo **N** (1 ≤ **N** ≤ 100000). A seguir existem **N** linhas. Cada uma dessas **N** linhas tem um único inteiro não negativo **T**, que indica o número de anos transcorridos até 2015 D.C. (0 ≤ **T** < 2^31).
